...
$result = mysqli_query($con, "SELECT * FROM users");
   ...
   while($res = mysqli_fetch_array($result,MYSQLI_ASSOC)) 
    {
        echo "<td ><h4 style='font-size:22px;font-family:cursive;'>Name :- $res[name]  :--<a  href=\"edit.php?id=$res[id]\">Edit</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></h4></td><br>";		
    }
